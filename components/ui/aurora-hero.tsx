...
export function AuroraHero({
  ...
  return (
    ...
    >
      <style>{`
        .aurora-hero-wrapper {
          /* White stripes on a white ground: the stripe pass disappears and only
             the rainbow survives, as soft pastel. That is the surface solid
             black type can actually sit on. */
          --stripe-color: #fff;
          --bg-filter: blur(12px) opacity(42%) saturate(160%);
          background: var(--background, #fdfcff);
        }
        ...
        .h1-scalingSize {
          font-family: var(--font-display, var(--font-bricolage)), Inter, sans-serif;
